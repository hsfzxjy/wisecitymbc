...
from rest_framework.templatetags.rest_framework import replace_query_param, replace_query_params
...
class BasePaginationSerializer(serializers.Serializer):
    ...
    def to_native(self, *args, **kwargs):
        self.object.object_list = self.object.object_list[:]
        return super(BasePaginationSerializer, self).to_native(*args, **kwargs)
