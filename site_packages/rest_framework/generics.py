...
from .custom_filters import get_timeline_filter, is_timeline_filter
...
class GenericAPIView(views.APIView):
    ...
    def paginate_queryset(self, queryset, page_size=None):
        ...
        # page.min_id = page.max_id = None

        # if self.is_timeline and page.object_list:
        #     aggregate_results = page.object_list.aggregate(min_id = Min('id'), max_id = Max('id'))
        #     page.min_id = aggregate_results['min_id']
        #     page.max_id = aggregate_results['max_id']
